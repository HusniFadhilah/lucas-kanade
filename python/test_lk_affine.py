...
log_file = os.path.join(log_path, f"lk_affine/{data_name}_performance_log.txt")
...
for i in range(numFrames-1):
    ...
    # run algorithm
    M,avg_pixel_diff = LucasKanadeAffine(It, It1, rect)
    ...
    save_path = f"{helper.resultdir}/lk_affine/{data_name}/frame{i+1:06d}.jpg"
