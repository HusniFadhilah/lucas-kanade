...
log_file = os.path.join(log_path, f"ic_affine/{data_name}_performance_log.txt")
...
for i in range(numFrames-1):
    ...
    # run algorithm
    M,avg_pixel_diff = InverseCompositionAffine(It, It1, rect)
    logging.info(f"Frame {i}, Affine Matrix M: {M}")
    ...
    save_path = f"{helper.resultdir}/ic_affine/{data_name}/frame{i+1:06d}.jpg"
